...
// con los valores que sean mayor que 18
const ages = [22, 14, 24, 55, 65, 21, 12, 13, 90];
const paresAge = ages.filter((num) => {
    return num % 2 == 0;
});
...
const lolPlayers = streamers.filter((games) => {
...
const playersGameMorePlayed = streamers.filter((player) => {
    return player.gameMorePlayed.includes("Legends");
});
